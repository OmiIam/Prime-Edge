// ISO 3166-1 alpha-2 country codes for global compliance
// Used in KYC country of residence dropdown
...
// Comprehensive list of countries for global KYC compliance
...
// Utility functions for country operations
...
// Get popular countries (commonly used for KYC)
export const getPopularCountries = (): Country[] => {
  const popularCodes = [
    'US', 'GB', 'CA', 'AU', 'DE', 'FR', 'JP', 'CN', 'IN', 'BR',
    'MX', 'IT', 'ES', 'NL', 'SE', 'CH', 'NO', 'DK', 'FI', 'BE',
    'AT', 'IE', 'PT', 'GR', 'PL', 'CZ', 'HU', 'RO', 'BG', 'HR',
    'ZA', 'NG', 'KE', 'GH', 'EG', 'MA', 'TN', 'DZ', 'ET', 'UG'
  ];
